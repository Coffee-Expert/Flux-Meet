    ...
    <div className="homePage">
      <header className="home-header">
        <div className="home-logo">
          <WhatshotIcon style={{ fontSize: "3rem" }} />
        </div>
          ...
          <section className="home-intro">
            <div className="intro-text">
              <h2>
                <ReactTyped
                  strings={[
                    "Your Lightning Connections Await!!",
                    "Seamless Video Conferencing for Your Team!",
                    "Host meetings effortlessly!",
                    "Collaborate with your team!",
                    "Experience seamless video calls!",
                  ]}
                  typeSpeed={40}
                  backSpeed={50}
                  loop
            ...
            <img
              style={{
                ...
                right: "60px",
                top: "130px",
                boxShadow: "0px 9px 10px rgba(0, 0, 128, 0.3)",
              }}
              src="https://images.unsplash.com/photo-1573164713712-03790a178651?q=80&w=2069&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            ></img>
      ...
      <section className="about-app" style={{ marginTop: "150px" }}>
        <div className="box">
                  ...
                  <div class="card-front">
                    <figure>
                      ...
                      <figcaption>
                        <Card.Title>
                          <Groups2Icon
                            style={{ fontSize: "4rem", marginTop: "-5rem" }}
                          />
                        </Card.Title>
      ...
      <footer className="home-footer">
        <h4>Flux Meet</h4>
        <p>
          Made by Abhishek Kevin Gomes for{" "}
          <strong>SmartInternz Internship</strong>. All Rights Reserved.
        </p>
